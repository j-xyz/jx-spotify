...
pub enum Command {
    ...
    GoToRadioFromSelectedItem,
    GoToRadioFromCurrentTrack,
    GoToRadioFromCurrentContext,
...
impl Command {
    pub fn desc(self) -> String {
        ...
        match self {
            ...
            Self::GoToRadioFromSelectedItem => "open radio for the selected item",
            Self::GoToRadioFromCurrentTrack => "open radio for the current track",
            Self::GoToRadioFromCurrentContext => "open radio for the current context",
            ...
            Self::SearchTuiHome => "go to a fresh search home view",
